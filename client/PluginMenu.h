...
private:
...
#if defined(SAMP_RU)
    static constexpr auto kTitleText                       = "Cài đặt";
    ...
    static constexpr auto kTab1Desc2BalancerText           = "Làm mượt âm thanh";
    static constexpr auto kTab1Desc2FilterText             = "Bộ lọc thông cao";
    static constexpr auto kTab1Desc3TitleText              = "Biểu tượng trên người chơi";
    static constexpr auto kTab1Desc3SpeakerIconScaleText   = "Tỉ lệ";
    static constexpr auto kTab1Desc3SpeakerIconOffsetXText = "Độ lệch X";
    static constexpr auto kTab1Desc3SpeakerIconOffsetYText = "Độ lệch Y";
    static constexpr auto kTab1Desc4TitleText              = "Cài đặt lại";
    static constexpr auto kTab1Desc4ConfigResetText        = "Đặt lại tất cả các thiết lập";
    static constexpr auto kTab2TitleText                   = "Microphone";
    static constexpr auto kTab2Desc1TitleText              = "Thiết bị";
    static constexpr auto kTab2Desc1EnableMicroText        = "Bật micrô";
    static constexpr auto kTab2Desc1MicroVolumeText        = "Âm lượng micrô";
    static constexpr auto kTab2Desc1DeviceNameText         = "Thiết bị đầu vào";
    static constexpr auto kTab2Desc1CheckDeviceText        = "Kiểm tra thiết bị (sẽ lặp lại)";
    static constexpr auto kTab2Desc2TitleText              = "Biểu tượng micro";
    static constexpr auto kTab2Desc2MicroIconScaleText     = "Tỉ lệ";
    static constexpr auto kTab2Desc2MicroIconPositionXText = "Vi trí X";
    static constexpr auto kTab2Desc2MicroIconPositionYText = "Vi trí Y";
    static constexpr auto kTab2Desc2MicroIconMoveText      = "Di chuyển";
    static constexpr auto kTab2Desc3MicroNotFoundText      = "Không có micro";
    static constexpr auto kTab3TitleText                   = "Danh sách đen";
    static constexpr auto kTab3Desc1TitleText              = "Lọc";
    static constexpr auto kTab3Desc1InputPlaceholderText   = "Nhập ID của người chơi...";
    static constexpr auto kTab3Desc2PlayerListText         = "Người chơi trên máy chủ";
    static constexpr auto kTab3Desc3BlackListText          = "Người chơi bị cấm";
#elif defined(SAMP_EN)
    static constexpr auto kTitleText                       = "Cài đặt trò chuyện thoại";
